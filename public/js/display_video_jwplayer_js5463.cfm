...
var playerConfigmediaspaceShowModal = {
	"playlist": [{
		"sources": [
			...
			{ "type": "hls", "label": "Auto-HLS", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683709420_fbe3ce1ecce15de3b2133a0c931e80bafd944d37/2018/10/tracey-mallet/5889/video/h264-,504p,720p,360p,216p.m3u8" },
			{ "type": "mpd", "label": "Auto-MPD", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683709420_fbe3ce1ecce15de3b2133a0c931e80bafd944d37/2018/10/tracey-mallet/5889/video/h264-,504p,720p,360p,216p.mpd" }, {}
			
		],
		"image": "//images.pilatesanytime.com/2018/12/21/large_welcome1-93977.jpg",
		
		"tracks": [
			
			{ "kind": "thumbnails", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683709420_b2df990dcb9b2f258f05a5b7fe59a5af6a699b20/2018/10/tracey-mallet/5889/thumbs/160x90.vtt" },
...
if (typeof initJWPlayerMux !== 'undefined') {
	initJWPlayerMux(playermediaspaceShowModal, {
		...
		data: {
			...
			video_id: '7339', // ex: 'abcd123'
			video_title: '7339: ', // ex: 'My Great Video'
...
playermediaspaceShowModal.on('pause', function(data) { 
	...
	videoIsPlaying = 0;
	if (document.ga) ga('send', 'event', 'video', 'pause', 'video_id', 7339);
});
...
playermediaspaceShowModal.on('play', function(data) {
	...
	if (document.ga) ga('send', 'event', 'video', 'play', 'video_id', 7339);
...
playermediaspaceShowModal.on('complete', function() {
	...
	if (document.ga) ga('send', 'event', 'video', 'complete', 'video_id', 7339);
...
playermediaspaceShowModal.on('error', function(error) {
	...
	if (document.ga) ga('send', 'event', 'video', 'error', 'video_id', 7339);
...
function markWatched(my_action) {		
	...
	if (my_action == 'mediaPlay' || my_action == 'mediaStop' || my_action == 'mediaComplete' || my_action == 'mediaProgress') {
		var myResult = instance.saveClassView(7339, -1, '-1', my_action, -1, my_position);
	}
