...
var playerConfigmediaspaceClassModal = {
	"playlist": [{
		"sources": [
			...
			{ "type": "hls", "label": "Auto-HLS", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683708688_8a64ea5264566894e7417688f83cf48ace6e95e8/2021/08/madeline-black/7238_marketing/video/h264-,504p,720p,360p,216p.m3u8" },
			{ "type": "mpd", "label": "Auto-MPD", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683708688_8a64ea5264566894e7417688f83cf48ace6e95e8/2021/08/madeline-black/7238_marketing/video/h264-,504p,720p,360p,216p.mpd" }, {}
			
		],
		"image": "//images.pilatesanytime.com/2022/04/04/large_full_madeline_210813_PA7238187387-20381.jpg",
		
		"tracks": [
			
			{ "kind": "thumbnails", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683708688_2c395b7d454011febd325df40c1e51bbb1050b11/2021/08/madeline-black/7238_marketing/thumbs/160x90.vtt" },
...
if (typeof initJWPlayerMux !== 'undefined') {
	initJWPlayerMux(playermediaspaceClassModal, {
		...
		data: {
			...
			video_id: '9074', // ex: 'abcd123'
			video_title: '9074: ', // ex: 'My Great Video'
...
playermediaspaceClassModal.on('pause', function(data) { 
	...
	videoIsPlaying = 0;
	if (document.ga) ga('send', 'event', 'video', 'pause', 'video_id', 9074);
});
...
playermediaspaceClassModal.on('play', function(data) {
	...
	if (document.ga) ga('send', 'event', 'video', 'play', 'video_id', 9074);
...
playermediaspaceClassModal.on('complete', function() {
	...
	if (document.ga) ga('send', 'event', 'video', 'complete', 'video_id', 9074);
...
playermediaspaceClassModal.on('error', function(error) {
	...
	if (document.ga) ga('send', 'event', 'video', 'error', 'video_id', 9074);
...
function markWatched(my_action) {		
	...
	if (my_action == 'mediaPlay' || my_action == 'mediaStop' || my_action == 'mediaComplete' || my_action == 'mediaProgress') {
		var myResult = instance.saveClassView(9074, -1, '-1', my_action, -1, my_position);
	}
