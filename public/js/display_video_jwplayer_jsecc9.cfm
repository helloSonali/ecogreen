...
var playerConfigmediaspaceClassModal = {
	"playlist": [{
		"sources": [
			...
			{ "type": "hls", "label": "Auto-HLS", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683708494_4b6fb5f5f57bf40a33a9c44c318dcfe431cb0421/2017/12/meredith-rogers/5202_marketing/video/h264-,504p,720p,360p,216p.m3u8?subtitles=en" },
			{ "type": "mpd", "label": "Auto-MPD", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683708494_4b6fb5f5f57bf40a33a9c44c318dcfe431cb0421/2017/12/meredith-rogers/5202_marketing/video/h264-,504p,720p,360p,216p.mpd" }, {}
			
		],
		"image": "//images.pilatesanytime.com/2018/05/23/large_full_meri_171204_PA520235646-11276.jpg",
		
		"tracks": [
			
			{ "kind": "thumbnails", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683708494_3790f0a0b3952a740cdb391592c373d1504d0c9e/2017/12/meredith-rogers/5202_marketing/thumbs/160x90.vtt" },
...
if (typeof initJWPlayerMux !== 'undefined') {
	initJWPlayerMux(playermediaspaceClassModal, {
		...
		data: {
			...
			video_id: '7056', // ex: 'abcd123'
			video_title: '7056: ', // ex: 'My Great Video'
...
playermediaspaceClassModal.on('pause', function(data) { 
	...
	videoIsPlaying = 0;
	if (document.ga) ga('send', 'event', 'video', 'pause', 'video_id', 7056);
});
...
playermediaspaceClassModal.on('play', function(data) {
	...
	if (document.ga) ga('send', 'event', 'video', 'play', 'video_id', 7056);
...
playermediaspaceClassModal.on('complete', function() {
	...
	if (document.ga) ga('send', 'event', 'video', 'complete', 'video_id', 7056);
...
playermediaspaceClassModal.on('error', function(error) {
	...
	if (document.ga) ga('send', 'event', 'video', 'error', 'video_id', 7056);
...
function markWatched(my_action) {		
	...
	if (my_action == 'mediaPlay' || my_action == 'mediaStop' || my_action == 'mediaComplete' || my_action == 'mediaProgress') {
		var myResult = instance.saveClassView(7056, -1, '-1', my_action, -1, my_position);
	}
