...
var playerConfigmediaspaceClassModal = {
	"playlist": [{
		"sources": [
			...
			{ "type": "hls", "label": "Auto-HLS", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683708546_da3549300e7e1b6886616a22afb43155ff3b26e1/2021/08/kira-lamb/7249_marketing/video/h264-,504p,720p,360p,216p.m3u8" },
			{ "type": "mpd", "label": "Auto-MPD", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683708546_da3549300e7e1b6886616a22afb43155ff3b26e1/2021/08/kira-lamb/7249_marketing/video/h264-,504p,720p,360p,216p.mpd" }, {}
			
		],
		"image": "//images.pilatesanytime.com/2021/12/06/large_day5-85394.jpg",
		
		"tracks": [
			
			{ "kind": "thumbnails", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683708546_a1e23cf96d2591fcb613a87d41116c6025d28b15/2021/08/kira-lamb/7249_marketing/thumbs/160x90.vtt" },
...
if (typeof initJWPlayerMux !== 'undefined') {
	initJWPlayerMux(playermediaspaceClassModal, {
		...
		data: {
			...
			video_id: '8839', // ex: 'abcd123'
			video_title: '8839: ', // ex: 'My Great Video'
...
playermediaspaceClassModal.on('pause', function(data) { 
	...
	videoIsPlaying = 0;
	if (document.ga) ga('send', 'event', 'video', 'pause', 'video_id', 8839);
});
...
playermediaspaceClassModal.on('play', function(data) {
	...
	if (document.ga) ga('send', 'event', 'video', 'play', 'video_id', 8839);
...
playermediaspaceClassModal.on('complete', function() {
	...
	if (document.ga) ga('send', 'event', 'video', 'complete', 'video_id', 8839);
...
playermediaspaceClassModal.on('error', function(error) {
	...
	if (document.ga) ga('send', 'event', 'video', 'error', 'video_id', 8839);
...
function markWatched(my_action) {		
	...
	if (my_action == 'mediaPlay' || my_action == 'mediaStop' || my_action == 'mediaComplete' || my_action == 'mediaProgress') {
		var myResult = instance.saveClassView(8839, -1, '-1', my_action, -1, my_position);
	}
