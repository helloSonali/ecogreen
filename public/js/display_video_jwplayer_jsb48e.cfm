...
var playerConfigmediaspaceClassModal = {
	"playlist": [{
		"sources": [
			...
			{ "type": "hls", "label": "Auto-HLS", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683709602_96f760478ff0c364289b647a7c897599b9cb30fb/2021/07/niedra-gabriel/7182_marketing/video/h264-,504p,720p,360p,216p.m3u8" },
			{ "type": "mpd", "label": "Auto-MPD", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683709602_96f760478ff0c364289b647a7c897599b9cb30fb/2021/07/niedra-gabriel/7182_marketing/video/h264-,504p,720p,360p,216p.mpd" }, {}
			
		],
		"image": "//images.pilatesanytime.com/2023/04/26/large_full_niedra_pa7182_21070825014-64607.jpg",
		
		"tracks": [
			
			{ "kind": "thumbnails", "file": "https://pilatesanytime-media.global.ssl.fastly.net/1683709602_0e8e012f06beba13f7f76eefca393f656be2668b/2021/07/niedra-gabriel/7182_marketing/thumbs/160x90.vtt" },
...
if (typeof initJWPlayerMux !== 'undefined') {
	initJWPlayerMux(playermediaspaceClassModal, {
		...
		data: {
			...
			video_id: '9511', // ex: 'abcd123'
			video_title: '9511: ', // ex: 'My Great Video'
...
playermediaspaceClassModal.on('pause', function(data) { 
	...
	videoIsPlaying = 0;
	if (document.ga) ga('send', 'event', 'video', 'pause', 'video_id', 9511);
});
...
playermediaspaceClassModal.on('play', function(data) {
	...
	if (document.ga) ga('send', 'event', 'video', 'play', 'video_id', 9511);
...
playermediaspaceClassModal.on('complete', function() {
	...
	if (document.ga) ga('send', 'event', 'video', 'complete', 'video_id', 9511);
...
playermediaspaceClassModal.on('error', function(error) {
	...
	if (document.ga) ga('send', 'event', 'video', 'error', 'video_id', 9511);
...
function markWatched(my_action) {		
	...
	if (my_action == 'mediaPlay' || my_action == 'mediaStop' || my_action == 'mediaComplete' || my_action == 'mediaProgress') {
		var myResult = instance.saveClassView(9511, -1, '-1', my_action, -1, my_position);
	}
